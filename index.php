    ...
    <div id="wrapper">
        ...
        <div id="pbody">
            <div id="jobsside" style="width: 40rem;height: auto;float: left;">
                ...
                ?>
                    <div class="card" style="width: 40rem; margin-bottom:10px; margin-top:10px;box-shadow: 5px 5px 5px 0;background-color:#f1a6a6">
                        <div class="card-body">
                            ...
                            <p class="card-text">Salary:<?php echo $row['Salery'];
                                                        echo "\t"; ?>RS a Month</p>
            ...
            <div id="sideforms" style="height: 100%;padding: 60px;width: 30rem;color:white;float: left;justify-content: center;align-items: center;">
                <h1 style="color:white;">Daily jobs Alert</h1>
                <form method="POST">
                    <div class="mb-3">
